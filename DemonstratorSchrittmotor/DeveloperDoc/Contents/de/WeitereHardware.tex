...
Dieser Spannungswandler wandelt die 12\ V vom Netzteil SNT RD 50A in jeweils 3,3\ V und 5\ V um. Die 3,3\ V werden für den Arduino, Schrittmotorsteuerung, OLED-Display und dem Drehwinkel-Encoder verwendet. Weitere Technische Daten des Wandlers sind:
\begin{itemize}
