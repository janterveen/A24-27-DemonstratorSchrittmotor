...
Der Motor ist mit der Last fest verbunden und wird mit konstanter Drehzahl betrieben. Innerhalb des ersten Schrittes muss der Motor auf die vorgegebene Frequenz beschleunigen, in Abbildung \ref{StartStoppFrequenz} erkennbar.\cite{FaulhaberDriveSystems.2020} 
...
\begin{figure}[H]
	...
	\caption{Start-Stopp Frequenz \cite{FaulhaberDriveSystems.2020}} \label{StartStoppFrequenz}
\end{figure}

{\textbf{Fehlerbild: Motor läuft nicht an(Ursachen und Lösungen ersichtlich in der Tabelle \ref{MOTLNA})} 
	\begin{center}
	...
	Der Motor kann mit einer im Controller vorgegebenen Beschleunigungsrate bis auf die Maximalfrequenz beschleunigen, in Abbildung \ref{TrapezförmigesGeschwindigkeitsprofil} erkennbar.\cite{FaulhaberDriveSystems.2020} 
	...
	\begin{figure}[H]
		...
		\caption{Trapezförmiges Geschwindigkeitsprofil \cite{FaulhaberDriveSystems.2020}} \label{TrapezförmigesGeschwindigkeitsprofil}
	\end{figure}
	{\textbf{Fehlerbild: Motor läuft nicht an} (siehe Ursachen und Lösungen aus Tabelle \ref{MOTLNA} \nameref{MOTLNA})
		
		{\textbf{Fehlerbild: Motor beendet die Beschleunigungsrampe nicht(Ursachen und Lösungen ersichtlich in der Tabelle \ref{MBRH})}
			\begin{center}
				\fontsize{8}{10}\selectfont
				\begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}
					\hline 
					...
					\end{itemize}\\ \hline
				\end{tabularx}
				\captionof{table}{Ursachen und Lösungen: Motor beendet die Beschleunigungsrampe nicht \cite{FaulhaberDriveSystems.2020}} \label{MBRH}	
			\end{center}
			
			{\textbf{Fehlerbild: Motor beschleunigt bis zur Enddrehzahl und bleibt stehen, sobald eine konstante Drehzahl erreicht ist(Ursachen und Lösungen ersichtlich in der Tabelle \ref{MBEKD}).}
				\begin{center}
					\fontsize{8}{10}\selectfont
					\begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}
						\hline 
						...
						\end{itemize}	 \\	\hline
					\end{tabularx}
					\captionof{table}{Ursachen und Lösungen: Motor beschleunigt bis zur Enddrehzahl und bleibt stehen, sobald eine konstante Drehzahl erreicht ist. \cite{FaulhaberDriveSystems.2020}} \label{MBEKD}
				\end{center}
