...
Der Motor ist mit der Last fest verbunden und wird mit konstanter Drezahl betrieben. Innerhalb des ersten Schritts muss der Motor auf die vorgegebene Frequenz beschleunigen.\cite{FaulhaberDriveSystems.2020} 
...
\caption{Start-Stopp Frequenz} \label{Start-Stopp Frequenz} 
\end{figure}
...
\begin{center}
	...
	\end{tabularx}
		\captionof{table}{Ursachen und Lösungen: Motor läuft nicht an} \label{MOTLNA}
\end{center}
...
\begin{figure}[!ht]
	...
	\caption{Trapezförmiges Geschwindigkeitsprofil} \label{Trapezförmiges Geschwindigkeitsprofil}
\end{figure}
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}
		...
		\end{itemize}\\ \hline
\end{tabularx}
	\captionof{table}{Ursachen und Lösungen: Motor beendet die Beschleunigungsrampe nicht}	
\end{center}
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}
		...
		\end{itemize}	 \\	\hline
	\end{tabularx}
			\captionof{table}{Ursachen und Lösungen: Motor beschleunigt bis zur Enddrehzahl und bleibt stehen, sobald eine konstante Drehzahl erreicht ist.}
\end{center}
