...
Durch die Ausarbeitung der Herausforderungen, können Lösungsansätze entwickelt werden. Vorab wurde eine erste Konzeptskizze angefertigt. Aus der Ideen entstanden. Im ersten Konzept sollte der Schrittmotor eine Plattform über einen Riementrieb axial verfahren, erkennbar in Abbildung \ref{ErsteKonzeptskizze}. Dabei sollte der Verfahrweg der Plattform über einen Abstandsensor mit einem vorher definierten Abstand zu einem Objekt, geregelt werden. Wird das Objekt näher oder weiter Weg vom Abstandssensor bewegt, verfährt die Plattform im Abstand mit. Alle vorhandenen Bauteile sollten an einem Alu-Profil befestigt werden.
...
Aufgrund hohen Komplexität wurde die Plattform inklusive des Abstandssensors aus dem zweiten Konzept, erkennbar in Abbildung \ref{ZweiteKonzeptskizze}, entfernt. Stattdessen wurde auf dem Schlitten der Linearführung ein Zeiger und auf dem Alu-Profil ein Lineal integriert. Mittels verschiedenen Modi soll der Schrittmotor unterschiedliche Bewegungsprofile demonstrieren. Vor allem sollte die Genauigkeit mit dem Zeiger präsentiert werden. Des Weiteren wurde eine Netzteil integriert, der sowohl den Motor als auch den Arduino mit Spannung versorgen sollte. Außerdem fanden ein Schalter zum Ein- und Ausschalten des Demonstrators, ein Stufenschalter zum Auswählen der Modi sowie ein Taster zum Starten des Demonstrierablaufes platz.  
