...
\section{Anwendung des Projektes}

Das Projekt hat das Ziel, die Funktionsweise eines Schrittmotors zu veranschaulichen. Das Projekt kann als anschauliches Lernmittel dienen. So können Schüler oder Studierende die Prinzipien der Schrittmotorsteuerung, einschließlich der Schrittauflösung und Positionierung praxisnah erlernen. Des Weiteren können Studierende den Demonstrator dazu nutzen, um praktische Erfahrung zu sammeln zum Beispiel durch Programmierübungen. Außerdem könnte solch ein Demonstrator als Qualitätskontrolle dienen, um die Leistungsfähigkeit sowie die Genauigkeit von Schrittmotoren zu prüfen und sicherzustellen, dass sie den erforderlichen Spezifikationen entsprechen. Ein weiteres Anwendungsgebiet können Messen sein, da mit solch einem Demonstrator gut die Bewegungsabläufe und die präzise Positionierung gezeigt werden kann. Das Projekt ist ein hilfreiches Tool für eine Messe, um Interesse zu wecken, Wissen zu vermitteln und gegebenenfalls potenzielle Kunden von der Leistungsfähigkeit und den Vorteilen der Technologie zu überzeugen. 

\section{Besondere Herausforderungen bei den Quellen}

Die Recherche nach verlässlichen Literaturquellen stellt eine große Herausforderung in wissenschaftlichen Arbeiten dar. Eine der größten Herausforderungen bei der Beschaffung von Literaturquellen ist die sprachliche Barriere, wenn relevante Quellen nur auf Englisch verfügbar sind. Durch diese Barriere kann das Verständnis und die Interpretation der Quellen erschwert werden. Mit diesem Problem ist ein erhöhter Aufwand verbunden, da Quellen häufig übersetzt werden müssen. Ein weiteres Problem bei der Ausarbeitung unseres Projektes war, dass wir trotz Nachfrage beim Hersteller kein Datenblatt für unseren Schrittmotor erlangen konnten. Datenblätter sind für solch ein technisches Projekt essenziell, da sie technische Spezifikationen und wichtige Informationen zu der Funktionsweise und Einsatzmöglichkeiten liefern. Das dritte Problem, das sich uns während des Projektes geboten hat, ist das Fehlen von Daten wie beispielsweise einem Datum.
